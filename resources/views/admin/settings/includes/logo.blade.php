<div class="card">
    <div class="card-header pb-0"><h3 class="tile-title">Site Logo</h3></div>
    <div class="card-body">
        <form action="{{ route('admin.settings.update') }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="tile-body">
                <div class="row">
                    <div class="col-3">
                        @if (\App\Models\Setting::get('site_logo') != null)
                            <img src="{{ asset('storage/'.\App\Models\Setting::get('site_logo')) }}" id="logoImg"
                ...
                <div class="row mt-4">
                    <div class="col-3">
                        @if (\App\Models\Setting::get('site_favicon') != null)
                            <img src="{{ asset('storage/'.\App\Models\Setting::get('site_favicon')) }}" id="faviconImg"
                                 style="width: 80px; height: auto;">
                        @else
